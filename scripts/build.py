...
def home()->str:
    ...
    <section class="hero-light"><div class="wrap">
      ...
      <div class="hero-photo bg-hero-green" role="img" aria-label="전기 배전반실 이미지"><div class="hero-photo-tag"><small>ON-SITE ELECTRICAL SAFETY</small><b>상주선임 · 위탁업체 변경 · 직접고용 전환</b></div><div class="path-grid">{path_cards}</div></div>
    </div></section>
